...
export default function AddNewChat(props) {
  ...
  return (
    <div
      ref={containerRef}
      className="relative select-none lg:min-w-[700px] md:min-w-[600px] min-w-[90%]  mx-auto bg-white rounded-3xl p-6 shadow-lg"
    >
      ...
      <div
        ...
        className="cursor-pointer flex justify-end top-3  z-50 absolute right-5"
      >
        <p>X</p>
      </div>
      ...
      <p className="md:text-sm text-xs font-normal mb-4 -mt-5 ms-4">
