  ...
  return (
    <nav className="bg-[#302F51] p-4 z-40">
      ...
      <div className="container mx-auto ">
        ...
        <div className="flex flex-col  justify-center items-center">
          ...
          <div>
            ...
            <div className="hidden lg:flex space-x-4 my-6">
              ...
              <Link href="/our-pack" className="text-white hover:text-gray-400">
                Our Pack
              </Link>
              <Link
                href="/contact-us"
        ...
        <div className="flex justify-between md:flex-row flex-col-reverse gap-6 md:gap-0 py-5">
          {/* Social Icons */}
