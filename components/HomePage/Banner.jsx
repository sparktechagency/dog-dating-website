...
const Banner = () => {
  return (
    <div className="relative md:h-[90vh] w-full overflow-hidden ">
      ...
      <div className=" md:hidden m-5 md:mt-40 ">
        {" "}
        {/* Adjust top to move up */}
        <Image
          loading="lazy"
      ...
      <div className="absolute inset-0 flex items-center justify-start left-[8%] md:top-[20%] -top-[18%] z-10">
        <motion.h1
          ...
          style={{ fontSize: "clamp(20px, 4vw + 1rem ,100px)" }}
          className="text-white font-inter font-bold md:mx-0 mx-auto  md:text-start text-center  leading-tight"
        >
