        ...
        <div className="flex gap-6 items-center md:items-start sm:flex-row flex-col">
          ...
          <div className="flex-1 ">
            ...
            <div className="space-y-2 text-white">
              <p className="text-xl">
                Age: <span className="text-black"> {pet?.age}</span>
              </p>
              <p className="text-xl">
                Gender:<span className="text-black">{pet?.gender}</span>{" "}
              </p>
              <p className="text-xl">
                Size: <span className="text-black"> {pet?.size}</span>{" "}
              </p>
              <p className="text-xl">
                City: <span className="text-black">{pet?.location}</span>{" "}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="border rounded-b-lg p-6 space-y-6 bg-white">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[#F88D58]">
              {" "}
              {pet?.preferences.sizePreference}
            </span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[#F88D58]">
              {" "}
              {pet?.preferences.locationPreference}
            </span>
          </div>
        </div>
      </div>
